/*
Theme Name: Anchorit International Limited
Theme URI: https://softkash.co
Author: Anchorit International Limited
Author URI: https://anchorit.com.ng
Description: SoftKash by Anchorit International Limited 
Version: 1.0
 License:
 License URI:
 */
  ...
  if ($('#gmap').length > 0) {
    ...
    var styles = [
      ...
      },
      {
        ...
        stylers: [{ saturation: 1 }, { weight: 0.1 }, { color: '#b1b1b1' }],
      },
    ];
    map.addStyle({
  ...
  if ($('#contactForm').length > 0) {
    $('#contactForm').on('submit', function (e) {
      ...
      if (required === 0) {
        $.ajax({
          type: 'POST',
          url: 'https://softkash-api.herokuapp.com/api/contacts',
          data: {
            first_name: f_name,
            last_name: l_name,
            email: email,
